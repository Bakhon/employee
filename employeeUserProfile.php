...
<section id="reviews" class="pt-5 bg-ultra-light">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div id="review9835" class="card mt-3 mb-4 shadow-sm rounded-xl">
                <div class="card-body px-3 px-md-4">
                    <div class="row">
                                ...
                                <div class="mt-3">
                                    <div class="my-1">
                                            <div class="float-right text-muted">
                                                <span>Отлично</span>
                                                <span id="w18" class="text-warning">
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                                    ...
                                    <div class="my-1">
                                            <div class="float-right text-muted">
                                                <span>Хорошо</span>
                                                <span id="w19" class="text-warning">
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                                    ...
                                    <div class="my-1">
                                            <div class="float-right text-muted">
                                                <span>Отлично</span>
                                                <span id="w20" class="text-warning">
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                                    ...
                                    <div class="my-1">
                                            <div class="float-right text-muted">
                                                <span>Хорошо</span>
                                                <span id="w21" class="text-warning">
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                                                    <svg class="i is-star"><use xlink:href="#s-star" /></use></svg>
                        ...
                        <div class="col-lg-8 mb-n4 pl-sm-5">
                            ...
                            <div class="mb-4">
                                    <svg class="text-muted position-absolute ml-n4 mt-1 d-none d-sm-block i ir-comment-lines"><use xlink:href="#r-comment-lines" /></use></svg>                        
                            ...
                            <div class="mb-4">
                                <div id="reply2340" class="mb-3">
                                    <div class="mb-1 middle">                            
                                        ...
                                        <b class="text-muted">Иван Иванов</b>    
                                    </div>
                                    <div class="card rounded-xl bg-light">
                                        <div class="card-body py-2">
                                            ...
                                            Спасибо Елена, за оценку и отзыв!        
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="text-center">
                <button type="button" class="btn btn-lg btn-secondary" onclick="$(this).hide(); $('#reviews').find('.card.hidden').fadeIn();">Показать еще отзывы </button>                       
            </div> 
...
<div class="py-5 text-center bg-ultra-light">
    <button type="button" class="btn btn-lg btn-secondary" data-modal="/profile/modal-review?user=3991">Оставить отзыв</button>            
</div>
        ...
        <div class="row justify-content-md-center">           
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 mb-4">
                 <div class="border p-1 shadow-sm rounded-lg position-relative pointer">
                    <a class="text-white" href="pics.html">
                     <img class="card-img-top rounded-lg" src="Theme/images/album/2503/fotooboi-262190.jpg" alt="Фото-обои">  
                    </a> 
...
<section id="docs" class="py-5">
    <div class="container">
        ...
        <div class="row justify-content-md-center photoswipe-gallery">
                ...
                <a href="Theme/images/docs/397436.jpg" data-photoswipe-gallery data-width="1203" data-height="720" data-gid="397436" data-pid="0">
                    <img class="img-thumbnail" src="Theme/images/docs/397436.jpg" alt="Специалист в области малярных работ"></a>    
                </div>
        </div>
    </div>
</section>
