...
<nav id="menu" class="navbar-main navbar-expand-lg navbar">
 ...
 <div class="container pt-3 mb-5">
        <h2 class="mb-3 text-center">Восстановление пароля</h2>
      ...
      <div class="col-sm-8 col-md-6 col-lg-5 col-xl-4">
        <div class="card border-2 border-primary">
            <div class="card-body px-4 px-sm-5 py-4">
                ...
                <form id="password-reset" action="/password-reset" method="post">
                    
                        <div class="form-group field-passwordresetform-phone required">
                            <label for="phone1">Телефон для входа</label>
                            <input type="text" id="phone1" class="form-control form-control-lg w-250px "  aria-required="true" >
                        ...
                        <div class="form-group">
                            <input id="reset_send" type="button" class="btn btn-primary btn-lg btn-block" value="Отправить СМС">                    
                        </div>


                         <div id="confirm_reset_pass" style="display:none" class="form-group  alert alert-info field-passwordresetform-code required">
                   
                            <div class="timer mb-2"></div>
                            <input type="text" id="passwordresetform-code" class="form-control form-control-lg w-250px" name="PasswordResetForm[code]" placeholder="Введите код" aria-required="true">
                        ...
                        <div id="confirm_sms" style="display:none" class="form-group">
                            <input id="send_confirm_sms_pass" type="button" class="btn btn-primary btn-lg btn-block" value="Подтвердить СМС">                    
                        </div>
