...
if(isset($_POST['title'])){
    ...
    $title = $_POST['title'];
    $sid = $_POST['sid'];
    $query = "SELECT u.*, us.*, d.NAME title FROM users u, users_speciality us, dic_country d WHERE u.id = us.USER_ID and u.LOCATION = d.ID and us.user_speciality = $sid and u.NAME LIKE '%$title%'";
