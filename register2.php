...
<!--  MENU -->
    ...
    <div class="container pt-3 mb-5">
        <div id="w0" class="mb-4 px-lg-5 steps">
            ...
            <div class="row">
                <div class="col-6 step "><div class="step-num">1</div>
        ...
        <div class="col-sm-9 col-md-7 col-lg-6 col-xl-5">
           ...
           <div>
            ...
            <div class="custom-control custom-checkbox">
                 <input type="hidden" id="id_user" value="<?php echo $_GET['phone'] ?>" />
                 <input type="hidden" id="type" value="<?php echo $_GET['type'] ?>" />
                <input type="checkbox" id="i35" class="custom-control-input check_all" name="TenderSearch[customer][]" value="1">
                <label class="custom-control-label" for="i35"><h4><b><?php echo $row['NAME_SPEC']; ?></b></h4></label>                                   
            </div>
            <?php 
...
<div>                                      
                    <div class="custom-control custom-checkbox">
                        <input data="<?php echo $roww['ID']; ?>" type="checkbox" id="<?php echo $roww['ID']; ?>" class="custom-control-input check" name="TenderSearch[customer][]" value="<?php echo $roww['ID']; ?>">
                        <label class="custom-control-label" for="<?php echo $roww['ID']; ?>"><?php echo $roww['NAME_SERV']; ?></label>
                    </div>                              
                </div>
              <?php
      }  } ?>
                        ...
                        <input type="button" class="btn btn-primary btn-lg btn-block register2" value="Сохранить"/>
                    </form>
                </div>
            </div>
        </div>
   ...
   if(pc != '') {
    $.post('server_reg.php', {"data": pc, "phone_s": $phone}, function(d){
        if(d == 1){
